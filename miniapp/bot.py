...
def app_kb(lang: str) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton(tx(lang, "trade"), url=PARTNER), InlineKeyboardButton(tx(lang, "channel"), url=CHANNEL)],
